...
```{r}
arrange(merged_data2, desc(VISIT), desc(tokens_CHI)) #Kid number 59 produced most words at second visti
arrange(merged_data2, VISIT, tokens_CHI) #Kid number 61 produced no words at first visit 
